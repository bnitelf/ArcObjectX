    ...
    partial class LicenseInitializer
    {
        ...
        private bool Initialize()
        {
            ...
            foreach (int prodNumber in m_requestedProducts)
            {
                ...
                sbLog.AppendLine($"Checking is ProductCode {prod} available, status = {status}");

                if (status == esriLicenseStatus.esriLicenseAvailable)
                {
                    sbLog.Append($"Initialize ProductCode {prod}");
        ...
        private const string MessageNoRuntimeBinding = "Invalid ArcGIS runtime binding. (No ArcGIS Runtime binded)";
